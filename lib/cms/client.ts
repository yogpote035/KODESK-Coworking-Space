...
type CmsState = { pricing: PricingRecord[]; media: MediaRecord[]; servicePages: ServicePageDetail[]; pageSections: PageSection[]; publishedDocuments: PublishedContentDocument[]; localSeoPages: LocalSeoPage[]; sectionSettings: CmsSectionSetting[]; settings: SiteSettings; loading: boolean };
const initial: CmsState = { pricing: [], media: [], servicePages: [], pageSections: [], publishedDocuments: [], localSeoPages: [], sectionSettings: [], settings: {}, loading: true };
