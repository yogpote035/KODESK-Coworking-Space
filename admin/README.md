...
2. Run the migrations in `../supabase/migrations/` in filename order in the Supabase SQL editor, including `202608220001_kodesk_services.sql` and `202608220002_gallery_categories.sql` for service and gallery management.
